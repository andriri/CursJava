...
public class VarargsExample {
	...
	//clasa JavascriptExecutor -pt ca toate browserele inteleg JavaScript
	//JavascriptExecutor.executeScript(jsScript , element )
	//JavascriptExecutor.executeScript(jsScript , element, element2 ) -- un numar mai mare cu o lista de parametrii 
	...
	public static  <T> void printCevaGeneric(T...values) { //am combinat Varargs cu parametrii clasici
		for(T obj : values) {
